...
async def whop_request(method: str, endpoint: str, api_key: str, data: Dict[str, Any] | None = None) -> Dict[str, Any]:
...
async def create_whop_product(api_key: str, title: str, description: str, price: float) -> Dict[str, Any]:
